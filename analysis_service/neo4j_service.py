...
class AnalysisRepository:
    ...
    def find_circular_patterns(self, min_amount=3000):
        with self.driver.session() as session:
            query = """
            MATCH path = (a:Account)-[:TRANSACTION*1..4]->(a)
    ...
    def analyze_networks(self):
        return 'hello from analyze_networks'

    def create_visualizations_service(self):
        return 'hello from create_visualizations_service'